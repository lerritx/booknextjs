...
return (
    ...
    <h1 className="text-4xl font-bold text-purple-600 mb-4">BSC Hospital - We care for you</h1>
    </div>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8">
    <div className="bg-white shadow-lg rounded-lg p-6 border-t-4 border-purple-500">
    <h2 className="text-2xl font-bold text-purple-600 mb-4">Our Services</h2>
